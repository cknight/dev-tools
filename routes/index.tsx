      ...
      <div class="p-4 mx-auto flex flex-col h-full">
        ...
        <div id="cards" class="flex justify-center flex-wrap mt-5">
          <a href="/password-generator">
            <div id="passwordCard" class="m-5 w-[300px] md:w-[400px] rounded overflow-hidden border-1 shadow-lg pt-5">
              ...
              <div class="px-6 py-4">
                ...
                <ul class="list-disc ml-5 mt-2">
                  ...
                  <li>Are inspired by the iconic <a href="https://xkcd.com/936/" target="_blank">XKCD comic</a></li>
                </ul>
              </div>
            </div>
          </a>
          <a href="/encoding-decoding">
            <div id="encodingCard" class="m-5 w-[300px] md:w-[400px] rounded overflow-hidden border-1 shadow-lg pt-5">
              <div class="w-1/3 m-auto flex justify-center items-center h-[120px]">
          ...
          <a href="/format-validate">
            <div id="formattingCard" class="m-5 w-[300px] md:w-[400px] rounded overflow-hidden border-1 shadow-lg pt-5">
              <div class="w-1/3 m-auto flex justify-center items-center h-[120px]">
          ...
          <a href="/text-diff">
            <div id="diffsCard" class="m-5 w-[300px] md:w-[400px] rounded overflow-hidden border-1 shadow-lg pt-5">
              <div class="w-1/3 m-auto flex justify-center items-center h-[120px]">
