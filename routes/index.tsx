    ...
    <Fragment>
      ...
      <div class="p-4 mx-auto flex flex-col h-full">
        ...
        <div id="cards" class="flex justify-center flex-wrap mt-5">
          ...
          <div id="formattingCard" class="m-5 w-[300px] md:w-[400px] rounded overflow-hidden shadow-lg pt-5 flex flex-col justify-center">
            <div class="w-1/3 m-auto flex justify-center items-center h-[120px]">
              <svg shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 386">
                <path fill="#00A912" fill-rule="nonzero" d="M0 362.47h512V386H0v-23.53z M0 0h512v23.54H0V0zm111.22 192.4L3.88 107.07v171.86c33.4-28.62 74.84-57.14 108.17-85.82l-.83-.71zm83.41 49.25H512v23.53H194.63v-23.53zm0-120.82H512v23.53H194.63v-23.53z"/>
              </svg>            
            </div>
            <div class="px-6 py-4">
