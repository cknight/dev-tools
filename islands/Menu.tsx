    ...
    <Fragment>
      ...
      <div class="">
        <nav id="popupMenu" class="hidden overflow-y-auto h-[calc(100%-120px)] w-[275px] border(1 dark:0 gray-200) bg(gray-100 dark:[#454545]) text(base left) z-50 absolute top-0 left-0 mt-20 list-none rounded shadow-lg min-w-48 ml-4">
          ...
          <MenuItem href="/base64-encode" text="Base64 encode" />
          <MenuItem href="/html-entity-encode" text="HTML entity encode" />
          <MenuItem href="/url-encode" text="URL encode" />
          <div class="block h-0 mx-4 my-2 border(b-[1px] solid blueGray-100 dark:black)"></div>
          ...
          <MenuItem href="/base64-decode" text="Base64 decode" />
          <MenuItem href="/html-entity-decode" text="HTML entity decode" />
          <MenuItem href="/jwt-decode" text="JWT decode" />
          <MenuItem href="/url-decode" text="URL decode" />
          <div class="block h-0 mx-4 my-2 border(b-[1px] solid blueGray-100 dark:black)"></div>
        ...
        <header id="headerAndNavBar" class="relative bg(gray-100 dark:[#454545]) border(1 dark:0 gray-200) shadow(md) dark:text-[#ffffff] flex items-center px-2 py-02 h-[59px]">
          ...
          <div id="logo" class="flex ml-5 z-10">
            <h1 class="hidden sm:block">
                <a href="/" class="z-50 cursor-pointer flex items-center">
