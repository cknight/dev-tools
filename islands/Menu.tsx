  ...
  return (
    <Fragment>
      ...
      <div class="flex flex-col">
        <header id="logoAndName" class="bg(white dark:[#454545]) shadow(md) dark:text-[#ffffff] flex items-center justify-between px-8 py-02 h-[59px]">
            <h1>
            ...
            <nav id="menuBarNavItems" class="hidden md:block">
            ...
            <div class="ml-2 flex items-center">
              ...
              <div id="popupMenu" class="hidden w-[180px] bg(white dark:[#454545]) text(base left) z-50 absolute top-0 right-0 mt-20 list-none rounded shadow-lg min-w-48 mr-4">
                  <a href="/password-generator" onKeyPress={() => goTo('/password-generator')} class={PASSWORD_GENERATOR + " flex md:hidden items-end p-4 border(r-8 [#d43900] opacity-0 hover:opacity-100) text(hover:[#d43900] hover:dark:white) duration-200 cursor-pointer active hover:dark:bg-[#525252]"}>
                  ...
                  <a href="/encoding-decoding" onKeyPress={() => goTo('/encoding-decoding')} class={ENCODER_DECODER + " flex md:hidden items-end p-4 border(r-8 [#d43900] opacity-0 hover:opacity-100) text(hover:[#d43900] hover:dark:white) duration-200 cursor-pointer active hover:dark:bg-[#525252]"}>
                  ...
                  <a href="/format-validate" onKeyPress={() => goTo('/format-validate')} class={FORMATTER + " flex md:hidden items-end p-4 border(r-8 [#d43900] opacity-0 hover:opacity-100) text(hover:[#d43900] hover:dark:white) duration-200 cursor-pointer active hover:dark:bg-[#525252]"}>
                    <div class="w-[20px] mr-2 flex justify-center items-center">
                  ...
                  <a href="/text-diff" onKeyPress={() => goTo('/text-diff')} class={TEXT_DIFF + " flex md:hidden items-end p-4 border(r-8 [#d43900] opacity-0 hover:opacity-100) text(hover:[#d43900] hover:dark:white) duration-200 cursor-pointer active hover:dark:bg-[#525252]"}>
                    <div class="w-[20px] mr-2 flex justify-center items-center">
