  ...
  return (
    <Fragment>
      ...
      <div id="popupMenu" class="hidden w-[180px] bg-white text-base z-50 absolute top-0 right-0 mt-20 list-none text-left rounded shadow-lg min-w-48">
        <a href="/password-generator" class={PASSWORD_GENERATOR + " flex md:hidden items-end p-4 border-b-2 border-yellow-600 border-opacity-0 hover:border-opacity-100 hover:text-yellow-600 duration-200 cursor-pointer active"}>
        ...
        <a href="/encoding-decoding" class={ENCODER_DECODER + " flex md:hidden items-end p-4 border-b-2 border-yellow-600 border-opacity-0 hover:border-opacity-100 hover:text-yellow-600 duration-200 cursor-pointer active"}>
        ...
        <a href="/format-validate" class={FORMATTER + " flex md:hidden items-end p-4 border-b-2 border-yellow-600 border-opacity-0 hover:border-opacity-100 hover:text-yellow-600 duration-200 cursor-pointer active"}>
          <div class="w-[20px] mr-2 flex justify-center items-center">
            <svg class="h-[30px]" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 386">
              <path fill="#f08900" fill-rule="nonzero" d="M0 362.47h512V386H0v-23.53z M0 0h512v23.54H0V0zm111.22 192.4L3.88 107.07v171.86c33.4-28.62 74.84-57.14 108.17-85.82l-.83-.71zm83.41 49.25H512v23.53H194.63v-23.53zm0-120.82H512v23.53H194.63v-23.53z"/>
            </svg>            
          </div>
          <div>
            Formatting
        ...
        <a href="/text-diff" class={TEXT_DIFF + " flex md:hidden items-end p-4 border-b-2 border-yellow-600 border-opacity-0 hover:border-opacity-100 hover:text-yellow-600 duration-200 cursor-pointer active"}>
          <div class="w-[20px] mr-2 flex justify-center items-center">
        ...
        <a href="https://github.com/cknight/dev-tools" class="flex p-4 border-b-2 border-yellow-600 border-opacity-0 hover:border-opacity-100 hover:text-yellow-600 duration-200 cursor-pointer active">
          <div class="w-[20px] mr-2 flex justify-center items-center">
