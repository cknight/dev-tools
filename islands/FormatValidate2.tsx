            ...
            <div ref={output} class="flex flex-col mx-px h-1/2 sm:h-full sm:w-1/2 overflow-auto">
              <div class="flex justify-between mr-1 mb-1">
                ...
                <div id="buttons" class="h-full flex gap-1">
                  ...
                  <button ref={restoreButton} onClick={restore} aria-label="Restore" title="Restore" class="hidden h-full bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold px-2 my-px rounded inline-flex items-center focus:outline-none focus:ring-1 focus:ring-blue-400">
