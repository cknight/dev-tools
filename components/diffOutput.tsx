...
export function DiffOutput(props: DiffProps) {
  ...
  function switchTab(): void {
    ...
    if (diffType.value == "sideBySide") {
      inlineTab.classList.add('bg-white', 'dark:bg-[#505050]', 'font-semibold', 'shadow');
      sideBySideTab.classList.add('font-medium');
      sideBySideTab.classList.remove('bg-white', 'dark:bg-[#505050]', 'font-semibold', 'shadow');
      diffType.value = "inline";
    } else if (diffType.value == "inline") {
      sideBySideTab.classList.add('bg-white', 'dark:bg-[#505050]', 'font-semibold', 'shadow');
      inlineTab.classList.add('font-medium');
      inlineTab.classList.remove('bg-white', 'dark:bg-[#505050]', 'font-semibold', 'shadow');
  ...
  return (
    <div id="diffContainer" class={`(${(props.diffContent && props.diffContent.length > 0 && initComplete.value) ? '' : 'hidden'}) flex flex-col`}>
      <div id="diffTypeTabContainer" class="flex justify-end w-full mb-2">
        <div class="flex space-x-1 rounded-lg bg(blue-100 dark:blue-500) p-0.5" role="tablist" aria-orientation="horizontal">
          ...
          <button onClick={() => {switchTab(); document.getElementById('sideBySideTab')!.blur();}} id="sideBySideTab" class="flex items-center rounded-md px-3 py-1 bg-white font-semibold shadow dark:bg-[#505050]" role="tab" type="button">
