...
export function Checkbox(props: CheckboxProps) {
  ...
  return <div class={tw`form-check flex align-center`}>
            <input class={tw`form-check-input 
                ...
                cursor-pointer`}
              style={checkboxImg} 
              type="checkbox" value="" id={props.id} defaultChecked={value} onChange={updateValue}/>
            <label class={tw`form-check-label inline-block text-gray-800`} for={props.id}>
              {props.label}
            </label>
          </div>;
}